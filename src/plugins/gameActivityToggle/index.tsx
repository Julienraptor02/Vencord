...
function makeIcon(showCurrentGame?: boolean) {
    ...
    return function () {
        return (
            <div className="lottieIcon_f73ef7" style={{
                "--__lottieIconColor": "var(--channel-icon)", display: "flex", width: "20px", height: "20px",
            } as React.CSSProperties}>
                <svg width="20" height="20" viewBox="0 0 24 24">
                    <path
                        fill={!showCurrentGame && !oldIcon ? "var(--status-danger)" : "var(--__lottieIconColor)"}
